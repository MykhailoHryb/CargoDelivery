---
Task: Rework your pet project with Spring framework, using java configuration, DAO layer leave as is, without usage of ORM frameworks.

---
Для того щоб запустити проект потрібно виконати команду "mvn tomcat7:run"
База данних : MySQL v. 8.0.22
Версія java : 1.8
